...
router.post(
  ...
  (req, res, next) => {
    if (typeof tokenController.generateWebSocketToken === "function") {
      ...
      console.error(
        "generateWebSocketToken is not a function:",
        tokenController.generateWebSocketToken
      );
