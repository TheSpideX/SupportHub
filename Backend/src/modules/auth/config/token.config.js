...
if (!process.env.ACCESS_TOKEN_SECRET) {
  console.warn(
    "WARNING: ACCESS_TOKEN_SECRET not found in environment variables. Using default (UNSAFE for production)."
  );
}
if (!process.env.REFRESH_TOKEN_SECRET) {
  console.warn(
    "WARNING: REFRESH_TOKEN_SECRET not found in environment variables. Using default (UNSAFE for production)."
  );
}
if (!process.env.CSRF_SECRET) {
  console.warn(
    "WARNING: CSRF_SECRET not found in environment variables. Using default (UNSAFE for production)."
  );
}
