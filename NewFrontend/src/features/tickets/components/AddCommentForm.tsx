...
import { addCommentDirectFetch } from "../utils/directTicketApi";
...
const AddCommentForm: React.FC<AddCommentFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // First try using the direct fetch approach
      const commentData = {
        text: comment,
      ...
      // Use direct fetch API instead of RTK Query
      await addCommentDirectFetch(ticketId, commentData);
