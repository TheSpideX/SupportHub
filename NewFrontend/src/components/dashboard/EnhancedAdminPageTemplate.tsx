...
interface EnhancedAdminPageTemplateProps {
  title: string;
  description: string;
  icon: IconType;
...
const EnhancedAdminPageTemplate: React.FC<EnhancedAdminPageTemplateProps> = ({
  title,
  description,
  icon: Icon,
  children,
...
export default EnhancedAdminPageTemplate;
