 ...
 * 
 * This script properly handles password hashing by using the User model's methods
 * to ensure passwords are stored correctly.
 * 
...
async function createUsers(organizationId) {
  ...
  for (const userData of TEST_USERS) {
    try {
      ...
      // Create user with plain text password - the model will hash it
