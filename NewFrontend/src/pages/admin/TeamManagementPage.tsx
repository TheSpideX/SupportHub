...
const TeamManagementPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchTeams();
    // Also fetch my teams to ensure we see teams we're a member of
    fetchMyTeams();
  ...
  */
  ...
  const forceRefreshTeams = useCallback(() => {
    console.log("Force refreshing teams data...");

    // Show loading state
    setIsPageLoading(true);

    // Force refresh both teams lists immediately with cache invalidation
    Promise.all([fetchTeams(1, 10, true), fetchMyTeams(true)])
      .then(() => {
        ...
        <main className="flex-1 overflow-y-auto relative z-10">
          ...
          >
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex flex-wrap gap-2 text-xs text-gray-400">
                      <span className="bg-gray-800 px-2 py-1 rounded-md flex items-center">
                        <kbd className="px-1 bg-gray-700 rounded mr-1">Alt</kbd>
                ...
                <div className="flex space-x-2">
                  <Button
                    ...
                    className="bg-gray-700 hover:bg-gray-600 text-white shadow-md"
            ...
            <motion.div variants={itemVariants}>
              <Tabs
                defaultValue={
                  myTeams && myTeams.length > 0 ? "my-teams" : "all-teams"
                }
                className="w-full"
              >
                ...
                <TabsContent value="team-performance">
                  <motion.div variants={itemVariants} className="space-y-6">
                    ...
                    <div className="bg-gray-800/30 backdrop-blur-md rounded-xl shadow-xl border border-gray-700/50 p-6">
                      ...
                      <p className="text-gray-400 mt-1">
                        View detailed performance metrics and analytics for your
                        teams
                      </p>
