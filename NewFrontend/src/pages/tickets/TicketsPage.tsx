...
import { 
  FaTicketAlt, FaFilter, FaSearch, FaSort, FaEllipsisH, 
  FaExclamationCircle, FaClock, FaCheckCircle, FaTimesCircle
} from 'react-icons/fa';
import TopNavbar from '@/components/dashboard/TopNavbar';
import Sidebar from '@/components/dashboard/Sidebar';
import Footer from '@/components/dashboard/Footer';
import { Dialog, Transition } from '@headlessui/react';
import { FaTimes, FaUser, FaHistory, FaComment, FaPaperclip, FaEdit, FaCheck, FaUserPlus, FaCircle, FaArrowRight } from 'react-icons/fa';
...
const TicketAnalyticsModal = ({ isOpen, closeModal, ticketId }: { isOpen: boolean, closeModal: () => void, ticketId: string }) => {
            ...
            >
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-xl bg-gray-800 shadow-xl transition-all">
                ...
                <div className="p-6 max-h-[80vh] overflow-y-auto space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-700/30 rounded-lg p-5 border border-gray-600/50">
                      ...
                      <div className="space-y-3">
                        <div>
                          <p className="text-sm text-gray-400">Average First Response</p>
                          <p className="text-xl font-semibold text-white">{analytics.avgResponseTime}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-400">Average Resolution Time</p>
                          <p className="text-xl font-semibold text-white">{analytics.avgResolutionTime}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-700/30 rounded-lg p-5 border border-gray-600/50">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="font-medium text-white">Historical Patterns</h4>
                      </div>
                      <div className="space-y-3">
                        <div>
                          <p className="text-sm text-gray-400">Similar Tickets</p>
                          <p className="text-xl font-semibold text-white">{analytics.similarTicketsCount}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-400">Recurrence Rate</p>
                          <p className="text-xl font-semibold text-white">{analytics.recurrenceRate}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-700/30 rounded-lg p-5 border border-gray-600/50">
                      <div className="flex items-center gap-3 mb-3">
                        <FaExclamationCircle className="text-amber-400" size={20} />
                        <h4 className="font-medium text-white">Performance Metrics</h4>
                      </div>
                      <div className="space-y-3">
                        <div>
                          <p className="text-sm text-gray-400">Escalation Rate</p>
                          <p className="text-xl font-semibold text-white">{analytics.escalationRate}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-400">First Contact Resolution</p>
                          <p className="text-xl font-semibold text-white">{analytics.firstContactResolution}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Trend analysis */}
                  <div className="bg-gray-700/30 rounded-lg p-5 border border-gray-600/50">
                    <h4 className="font-medium text-white mb-4">Trend Analysis</h4>
                    <div className="h-64">
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          />
                          <Bar dataKey="tickets" fill="#3b82f6" name="Similar Tickets" />
                        </BarChart>
                      </ResponsiveContainer>
                    </div>
                    <p className="text-sm text-gray-400 mt-2">
                      Historical pattern of similar infrastructure tickets over the last 6 months
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-700/30 rounded-lg p-5 border border-gray-600/50">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h4 className="font-medium text-white">AI-Powered Recommendations</h4>
                    </div>
                    <ul className="space-y-2 text-gray-300">
                      <li className="flex items-start gap-2">
                        <span className="text-green-400 mt-1">•</span>
                        <span>Consider checking server load balancing configuration based on similar past issues</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-400 mt-1">•</span>
                        <span>Review recent network infrastructure changes that may have impacted connectivity</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-400 mt-1">•</span>
                        <span>Escalate to Network Operations team if not resolved within 24 hours</span>
                      </li>
                    </ul>
                  </div>
                </div>
...
const TicketsPage: React.FC<TicketsPageProps> = ({ view: initialView = 'all' }) => {
  const [currentView, setCurrentView] = useState<'all' | 'my-tickets' | 'create'>(initialView);
  ...
  const tickets: Ticket[] = [
    {
      ...
      description: 'Users are experiencing intermittent connection drops to the main server.',
      status: 'in_progress',
      priority: 'high',
    ...
    },
    {
      ...
      description: 'Several users reported that the dashboard takes more than 10 seconds to load.',
      status: 'open',
      priority: 'medium',
      category: 'Frontend',
    ...
    },
    {
      ...
      description: 'Security audit revealed a potential XSS vulnerability in the login form.',
      status: 'open',
      priority: 'high',
      category: 'Security',
    ...
    },
    {
      ...
      description: 'Multiple customers have requested the ability to export their data to CSV format.',
      status: 'resolved',
      priority: 'low',
    ...
    },
    {
      ...
      description: 'iOS users are reporting that the app crashes immediately after the splash screen.',
      status: 'closed',
      priority: 'high',
      category: 'Mobile',
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                    ...
                    {currentView === 'all' ? 'All Tickets' : currentView === 'my-tickets' ? 'My Tickets' : 'Create Ticket'}
                  </h1>
                  ...
                  >
                            ...
                            filteredTickets.map((ticket, index) => (
                              <React.Fragment key={ticket.id}>
                                ...
                                {expandedTicketId === ticket.id && (
                                  ...
                                  >
                                    <td colSpan={8} className="bg-gray-800/50 border-t border-b border-gray-700/50">
                                      <div className="p-4">
                    ...
                    <div className="px-6 py-4 flex items-center justify-between border-t border-gray-700">
                      ...
                      <div className="flex gap-2">
                        <button className="px-3 py-1 bg-gray-700/50 border border-gray-600/50 rounded text-gray-300 hover:bg-gray-600/50 transition-colors">
                          Previous
                        </button>
                        <button className="px-3 py-1 bg-blue-600 rounded text-white hover:bg-blue-700 transition-colors">
                          1
                        </button>
                        <button className="px-3 py-1 bg-gray-700/50 border border-gray-600/50 rounded text-gray-300 hover:bg-gray-600/50 transition-colors">
                          2
...
const ActivityTimeline = ({ activities }) => {
  ...
  const timelineData = activities || [
    { id: 1, status: 'created', title: 'Ticket Created', date: '2023-10-15T10:30:00Z', completed: true },
    { id: 2, status: 'assigned', title: 'Assigned to Team', date: '2023-10-15T11:45:00Z', completed: true },
    { id: 3, status: 'in_progress', title: 'Investigation Started', date: '2023-10-16T09:15:00Z', completed: true },
    { id: 4, status: 'solution_proposed', title: 'Solution Proposed', date: '2023-10-17T14:30:00Z', completed: false },
    { id: 5, status: 'resolved', title: 'Issue Resolved', date: null, completed: false },
    { id: 6, status: 'closed', title: 'Ticket Closed', date: null, completed: false },
  ];
...
const TicketDetailModal = ({ isOpen, closeModal, ticket }: { isOpen: boolean, closeModal: () => void, ticket: Ticket | null }) => {
  ...
  const ticketActivities = ticket.auditLog ? ticket.auditLog.map((log, index) => ({
    id: index,
    status: log.action,
    title: log.action.split('_').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' '),
    date: log.timestamp,
    completed: true
  })) : null;
  ...
  const getTicketActivityEvents = (ticketId: string) => {
    ...
    return [
      ...
      },
      {
        ...
        details: {
          title: 'Added Comment',
          description: 'Investigating the server logs to identify the root cause of connectivity issues.'
        }
      },
      {
        id: 'act-4',
                ...
                <Dialog.Panel className="w-full max-w-5xl transform overflow-hidden rounded-xl bg-gray-800 shadow-xl transition-all">
                  ...
                  <div className="border-b border-gray-700">
                    ...
                    <div className="flex px-6">
                      <button 
                        className={`px-4 py-2 border-b-2 ${activeTab === 'details' ? 'border-blue-500 text-blue-400' : 'border-transparent text-gray-400 hover:text-white'} font-medium transition-colors`}
                        onClick={() => setActiveTab('details')}
                      >
                        Overview
                      </button>
                      <button 
                        className={`px-4 py-2 border-b-2 ${activeTab === 'activity' ? 'border-blue-500 text-blue-400' : 'border-transparent text-gray-400 hover:text-white'} font-medium transition-colors`}
                        onClick={() => setActiveTab('activity')}
                      >
                        Activity
                      </button>
                      <button 
                        className={`px-4 py-2 border-b-2 ${activeTab === 'sla' ? 'border-blue-500 text-blue-400' : 'border-transparent text-gray-400 hover:text-white'} font-medium transition-colors`}
                  ...
                  <div className="p-6 max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="mb-8">
                      <h2 className="text-2xl font-bold text-white mb-4">{ticket.title}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                      <div className="bg-gray-700/30 rounded-lg p-5 flex items-center justify-between">
                        ...
                        <div className="text-2xl text-gray-400">
                          ...
                          {ticket.status === 'resolved' && <FaCheckCircle className="text-green-400" />}
                      ...
                      <div className="bg-gray-700/30 rounded-lg p-5 flex items-center justify-between">
                        ...
                        <div className="text-2xl text-gray-400">
                          {ticket.priority === 'critical' && <FaExclamationCircle className="text-red-400" />}
                          {ticket.priority === 'high' && <FaExclamationCircle className="text-orange-400" />}
                          {ticket.priority === 'medium' && <FaExclamationCircle className="text-yellow-400" />}
                          {ticket.priority === 'low' && <FaExclamationCircle className="text-green-400" />}
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-700/30 rounded-lg p-5 flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-white font-medium mt-1">{ticket.category}</p>
                        </div>
                        <div className="text-2xl text-gray-400">
                          <FaTicketAlt />
                        </div>
                    ...
                    <div className="mt-8">
                      {activeTab === 'details' && (
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                          ...
                          <div className="lg:col-span-2 space-y-6">
                              ...
                              <div className="h-64">
                                <ResponsiveContainer width="100%" height="100%">
                                  ...
                                  >
                                    ...
                                    <Bar dataKey="updates" fill="#10b981" name="Status Updates" />
                                  </BarChart>
                                </ResponsiveContainer>
                              </div>
                            </div>
                            ...
                            <div className="bg-gray-700/30 rounded-lg p-5">
                              <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-medium text-white">Comments & Updates</h3>
                          ...
                          <div className="space-y-6">
                            {/* Ticket metadata */}
                            <div className="bg-gray-700/30 rounded-lg p-5">
                              <h3 className="text-lg font-medium text-white mb-4">Ticket Details</h3>
                              ...
                              <div className="space-y-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-white mt-1">{formatDate(ticket.createdAt)}</p>
                                </div>
                                
                                <div>
                                  <p className="text-sm text-gray-400">Last Updated</p>
                                  <p className="text-white mt-1">{formatDate(ticket.updatedAt)}</p>
                                </div>
                                ...
                                {ticket.assignedTeam && (
                                  <div>
                                    ...
                                    <p className="text-white mt-1">{ticket.assignedTeam}</p>
                                  </div>
                                )}
                            ...
                            {ticket.sla && (
                              <div className="bg-gray-700/30 rounded-lg p-5">
                                <h3 className="text-lg font-medium text-white mb-4">SLA Status</h3>
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div>
                                    <p className="text-sm text-gray-400">Response Deadline</p>
                                    <p className="text-white mt-1">{formatDate(ticket.sla.responseDeadline)}</p>
                                  </div>
                                  
                                  <div>
                                    <p className="text-sm text-gray-400">Resolution Deadline</p>
                                    <p className="text-white mt-1">{formatDate(ticket.sla.resolutionDeadline)}</p>
                                  </div>
                                  
                                  <div>
                                    <p className="text-sm text-gray-400">SLA Progress</p>
                                    <div className="mt-2">
                                      <div className="flex items-center justify-between mb-1">
                                        <span className={ticket.sla.percentageComplete > 75 ? 'text-orange-400' : 'text-green-400'}>
                                          {ticket.sla.percentageComplete}% Complete
                                        </span>
                                      </div>
                                      <div className="w-full bg-gray-600 rounded-full h-2.5">
                                        <div 
                                          className={`h-2.5 rounded-full ${
                                            ticket.sla.percentageComplete > 75 ? 'bg-orange-500' : 'bg-green-500'
                                          }`}
                                          style={{ width: `${ticket.sla.percentageComplete}%` }}
                                        ></div>
                                      </div>
                                    </div>
                                  </div>
                      ...
                      {activeTab === 'activity' && (
                        <div className="space-y-4">
                          <h3 className="text-lg font-medium text-white mb-4">Ticket Activity</h3>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-gray-700/30 rounded-lg p-5">
                              ...
                              <div className="space-y-2">
                                <div className="flex justify-between items-center">
                                  ...
                                  <span className="font-medium text-white">{activityEvents.length}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                  <span className="text-gray-300">Last Updated</span>
                                  <span className="font-medium text-white">{new Date(activityEvents[0].timestamp).toLocaleString()}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                  <span className="text-gray-300">Contributors</span>
                                  <span className="font-medium text-white">
                                    {new Set(activityEvents.map(e => e.user.id)).size}
                                  </span>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="bg-gray-700/30 rounded-lg p-5">
                              <h4 className="text-md font-medium text-white mb-3">Response Metrics</h4>
                      ...
                      {activeTab === 'sla' && (
                        <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-gray-700/30 rounded-lg p-5">
                              <h4 className="text-md font-medium text-white mb-3">Response Time</h4>
                              <div className="h-64">
                                <ResponsiveContainer width="100%" height="100%">
                                  <PieChart>
                                    <Pie
                            ...
                            <div className="bg-gray-700/30 rounded-lg p-5">
                              <h4 className="text-md font-medium text-white mb-3">SLA Timeline</h4>
                              <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                  <span className="text-gray-300">Created</span>
                                  <span className="text-gray-300">Oct 15, 10:30 AM</span>
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                  <span className="text-gray-300">First Response</span>
                                  <span className="text-gray-300">Oct 15, 11:15 AM</span>
                                </div>
                                <div className="w-full bg-gray-700 h-2 rounded-full overflow-hidden">
                                ...
                                <div className="flex items-center justify-between">
                                  <span className="text-gray-300">Resolution Target</span>
                                  <span className="text-gray-300">Oct 17, 10:30 AM</span>
                                </div>
                                <div className="w-full bg-gray-700 h-2 rounded-full overflow-hidden">
                                ...
                                <div className="mt-4 p-3 bg-yellow-500/20 border border-yellow-500/30 rounded-md flex items-center">
                                  ...
                                  <span className="text-sm text-yellow-300">
                                    This ticket has reached 75% of its resolution SLA time
                                  </span>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="bg-gray-700/30 rounded-lg p-5">
                            <h4 className="text-md font-medium text-white mb-3">SLA Details</h4>
                            <div className="space-y-3">
                              <div className="flex justify-between items-center pb-2 border-b border-gray-600">
                                <span className="text-gray-300">Response SLA</span>
                              ...
                              <div className="flex justify-between items-center pb-2 border-b border-gray-600">
                                ...
                                <span className="text-yellow-400 flex items-center">
                                  <FaClock className="mr-1" /> In Progress (75% elapsed)
                                </span>
                              </div>
                              <div className="flex justify-between items-center pb-2 border-b border-gray-600">
                                <span className="text-gray-300">SLA Policy</span>
                                <span className="text-blue-400">High Priority - Server Issues</span>
                              </div>
                              <div className="flex justify-between items-center">
