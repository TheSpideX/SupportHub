...
import { FaSearch, FaBell, FaBars, FaMoon, FaSun, FaQuestion, FaCog, FaUserCircle, FaSignOutAlt, FaHistory } from "react-icons/fa";
...
const TopNavbar: React.FC<TopNavbarProps> = ({ onMenuClick, sidebarOpen, setSidebarOpen }) => {
  ...
  const [notifications, setNotifications] = useState([
    ...
    { id: 2, title: "System maintenance scheduled", time: "1 hour ago", read: false },
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Tooltip content={sidebarOpen ? "Close sidebar (Ctrl+B)" : "Open sidebar (Ctrl+B)"}>
              <button
            ...
            <div className="hidden md:block ml-4">
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Support Hub</h1>
            </div>
          </div>
                ...
                {showNotifications && (
                  ...
                  >
                    ...
                    <div className="max-h-80 overflow-y-auto">
                      {notifications.length > 0 ? (
                        notifications.map(notification => (
                          <div 
                            key={notification.id}
                            className={`px-4 py-3 border-b border-gray-100 dark:border-gray-700 last:border-0 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors ${!notification.read ? 'bg-blue-50 dark:bg-blue-900/10' : ''}`}
                          >
                    ...
                    <div className="px-4 py-2 border-t border-gray-100 dark:border-gray-700 text-center">
                      <a href="/notifications" className="text-xs text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 hover:underline">
                ...
                {showUserMenu && (
                  ...
                  >
                    ...
                    <div className="py-1">
                      ...
                      <a href="/activity" className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
